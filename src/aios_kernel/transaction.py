...
from aios_protocol.identifiers import AuditRecordId, CommandId, IntegrityReference, MessageId, OrganizationId, StreamId
...
class TransactionResult:
    ...
    def __post_init__(self) -> None:
        ...
        if self.status is TransactionStatus.CONFIRMED and self.disposition is None:
